...
define(chamfer,     10) // cylinder chamfer
...
(
    ...
    //- Valve stem upper
    arc valveStem0Up valveStem1Up evert( calc(valveStemD/2.0*cosd(45.0)), -calc(valveStemD/2.0*cosd(45.0)), calc(S + outletH))
    arc valveStem1Up valveStem2Up evert(-calc(valveStemD/2.0*cosd(45.0)), -calc(valveStemD/2.0*cosd(45.0)), calc(S + outletH))
    arc valveStem2Up valveStem3Up evert(-calc(valveStemD/2.0*cosd(45.0)),  calc(valveStemD/2.0*cosd(45.0)), calc(S + outletH))
    arc valveStem3Up valveStem0Up evert( calc(valveStemD/2.0*cosd(45.0)),  calc(valveStemD/2.0*cosd(45.0)), calc(S + outletH))
